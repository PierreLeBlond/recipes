...
const selectTriggerVariants = cva(
  "text-start peer h-full w-full rounded-[7px] border bg-transparent px-3 py-2 pr-9! font-sans text-sm font-normal outline outline-0 transition-all data-[state=open]:border-2 focus:border-2 focus:outline-0 disabled:cursor-not-allowed disabled:border-0",
  {
    variants: {
      variant: {
        default:
          "border-secondary border-t-transparent has-[span:empty]:border-secondary has-[span:empty]:border-t-secondary focus:border-secondary focus:border-t-transparent disabled:bg-secondary/20",
        edit: "border-edit border-t-transparent has-[span:empty]:border-edit has-[span:empty]:border-t-edit focus:border-edit focus:border-t-transparent disabled:bg-edit/20",
      },
    },
    defaultVariants: {
      variant: "default",
