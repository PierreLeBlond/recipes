...
export function EditSwitch() {
  ...
  return (
    <div className="xs:left-8 xs:top-20 xs:w-64 xs:rounded-lg xs:border fixed top-16 z-40 flex h-16 w-full items-center justify-center border-b backdrop-blur-md">
      <QueryParamsLink
